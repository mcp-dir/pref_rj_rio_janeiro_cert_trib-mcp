...
Prefeitura RJ Rio de Janeiro: Certidão Tributária de IPTU segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_rj_rio_janeiro_cert_trib@mcp.ai](mailto:pref_rj_rio_janeiro_cert_trib@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
